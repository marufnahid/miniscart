...
<main class="site-main">
	...
	<?php echo get_template_part('template-parts/common/shop-category'); ?>
	<?php echo get_template_part('template-parts/common/new-products'); ?>
	<?php echo get_template_part('template-parts/promo'); ?>
	<?php echo get_template_part('template-parts/popular-products'); ?>
	<?php echo get_template_part('template-parts/offers'); ?>
