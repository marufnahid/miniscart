...
?>
<!--page title start-->
<section class="page-title page-title-bg" style="background-image: url(<?php echo esc_url($image_url); ?>);">
                ...
                <div class="col-md-12">
                    <div class="bg-white px-5 py-4 rounded d-inline-block p">
                        ...
                        <nav class="woocommerce-breadcrumb">
                            <a href="#">Home</a>
                            <span class="breadcrumb-separator"> / </span>About us
                        </nav>
                    </div>
                </div>
            </div>
...
<main class="site-main">
    <section class="space-3">
        <div class="container">
            <?php
            if ('yes' == get_theme_mod('goal_title_switch',true)):
            ?>
            <div class="row justify-content-center mb-4 mb-lg-5">
                <div class="col-md-8 text-center">
                    <h2 class="font-weight-bold"><?php echo esc_html(get_theme_mod('goal_title')); ?></h2>
                    <p><?php echo esc_html(get_theme_mod('goal_subtitle')); ?></p>
                </div>
            </div>
            <?php
            endif;
            ...
            <div class="row">
                <?php
                $settings = get_theme_mod('goal_repeater_setting');
                foreach ($settings as $setting):
                ?>
                <div class="col-md-4">
                    <h4 class="font-weight-bold"><?php echo esc_html($setting['mission_title']);?></h4>
                    <p><?php echo esc_html($setting['mission_description']);?></p>
                </div>
                <?php
                endforeach;
               ?>
	...
	<?php echo get_template_part('template-parts/members'); ?>
	<?php echo get_template_part('template-parts/common/instagram'); ?>
