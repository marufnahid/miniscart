...
if ( ! function_exists( 'miniscart_adjust_body_class' ) ) {
	 ...
	 */
	function miniscart_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'miniscart_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function miniscart_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'miniscart' ),
		__( 'Previous', 'miniscart' ),
		__( 'Next', 'miniscart' ),
		__( 'About:', 'miniscart' ),
		__( 'Profile', 'miniscart' ),
		__( 'Posts by', 'miniscart' ),
		__( 'Permanent Link:', 'miniscart' ),
		__( 'in', 'miniscart' ),
		__( 'Edit', 'miniscart' ),
	);
}
